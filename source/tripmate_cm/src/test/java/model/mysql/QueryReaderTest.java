...
class QueryReaderTest {
    ...
    void get_all_pois_names() {
        List<String> pois = QueryReader.get_all_pois_names();
    ...
    void get_cities_by_state_name() {
        ...
        List<String> nm_cities = QueryReader.get_cities_by_state_name("New Mexico");
    ...
    void get_all_pois_details() {
        List<Map<String, String>> pois = QueryReader.get_all_pois_details();
        assertEquals(4672, pois.size());
    }

    @Test
    void get_pois_details_by_city_name() {
        List<Map<String, String>> de_pois = QueryReader.get_pois_details_by_city_name("Denver");
        assertEquals(41, de_pois.size());

        List<Map<String, String>> sd_pois = QueryReader.get_pois_details_by_city_name("San Diego");
        assertEquals(30, sd_pois.size());

        List<Map<String, String>> na_pois = QueryReader.get_pois_details_by_city_name("Nashville");
